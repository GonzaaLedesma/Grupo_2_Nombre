...
const validacionEdicionUsuario = require("../middlewares/edicionUsuarioMiddleware");
...
router.put('/perfil/edicion' ,upload.single('foto_perfil'), validacionEdicionUsuario, userController.perfilPut);
